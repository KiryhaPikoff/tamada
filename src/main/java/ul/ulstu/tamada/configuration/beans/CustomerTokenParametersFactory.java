...
@Component
public class CustomerTokenParametersFactory implements ITokenParametersFactory {

    private final TokenProperties tokenProperties;

    public CustomerTokenParametersFactory(
            @Qualifier("customerTokenProperties") TokenProperties tokenProperties
    ) {
